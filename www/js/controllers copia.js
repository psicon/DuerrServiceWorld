...
.run(function ($ionicPlatform,$ionicPopup,$rootScope,$ionicHistory) {
    ...
    if ($rootScope.backButtonPressedOnceToExit) {
      ...
      $rootScope.backButtonPressedOnceToExit = true;
       $ionicPopup.confirm({
             title: "{{ 'SCANBUTTONMENU' | translate }}",
...
alert("adding");
        ...
        getLastarticle: function () {
            ...
            if (localStorage["history"] === null || localStorage["history"] === "") {
               alert("empty history");
            } else {
...
.controller('getArticleByScanCtrl', function ($ionicViewService, HistoryBackService, $location, $ionicPopup, $state, $timeout, $scope, $http, $ionicLoading, RegisterDeviceService, SearchValueService, HistoryService, UserLoginService) {
    ...
    if (loaded == "true") {
        ...
        if (navigator.connection.type == Connection.NONE || navigator.connection.type == Connection.CELL_2G || navigator.connection.type == Connection.UNKNOWN) {
            ...
            $ionicPopup.alert({
                title: "ERROR",
                template: "{{ 'CHECKCONNECTION' | translate }} 4036"
            });
            ...
            /*var timer = $timeout(
                function () {
                    ...
                    var alertPopup = $ionicPopup.alert({
                        ...
                        template: "{{ 'CHECKCONNECTION' | translate }} 4054"
                    });
                },
                25000
            );*/
    ...
    $scope.doRefresh = function () {
        ...
        if (navigator.connection.type == Connection.NONE || navigator.connection.type == Connection.CELL_2G || navigator.connection.type == Connection.UNKNOWN) {
            ...
            $ionicPopup.alert({
                title: "ERROR",
                template: "{{ 'CHECKCONNECTION' | translate }} 4230"
            });
            ...
            /*var timer = $timeout(
                function () {
                    ...
                    var alertPopup = $ionicPopup.alert({
                        ...
                        template: "{{ 'CHECKCONNECTION' | translate }} 4247"
                    });
                },
                25000
            );*/
...
.controller('registerDeviceCtrl', function ($cordovaEmailComposer, $cordovaFlashlight, $ionicLoading, $ionicPopup, $scope, $stateParams, RegisterDeviceService, HistoryService, $window, UserLoginService) {
